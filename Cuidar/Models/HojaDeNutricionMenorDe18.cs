...
{
    public class HojaDeNutricionMenorDe18
    {
        ...
        public int semanasDeGestacion { get; set; }
        public string lactanciaMaterna { get; set; }
        public string inicioDeAlimentacionComplementaria { get; set; }
        public string lecheComplementaria { get; set; }
